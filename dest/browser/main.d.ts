...
export declare function proveAndVerify(jsonPath: string, witnessPath: string, isRecursive: boolean): Promise<boolean>;
export declare function prove(jsonPath: string, witnessPath: string, isRecursive: boolean, outputPath: string): Promise<void>;
...
export declare function writeVk(jsonPath: string, outputPath: string): Promise<void>;
